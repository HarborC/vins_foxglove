...
list(APPEND LIBRARY_SOURCES
        ...
        src/foxglove/FGVisualizer.cpp
        src/foxglove/dash_board.cpp
        src/serial/imu_serial.cpp
)
if (catkin_FOUND AND ENABLE_ROS)
...
if (catkin_FOUND AND ENABLE_ROS)
    ...
    add_executable(run_msckf_ros src/run_msckf_ros.cpp)
    target_link_libraries(run_msckf_ros ov_msckf_lib ${thirdparty_libraries})
    install(TARGETS run_msckf_ros
            ARCHIVE DESTINATION ${CATKIN_PACKAGE_LIB_DESTINATION}
            LIBRARY DESTINATION ${CATKIN_PACKAGE_LIB_DESTINATION}
            RUNTIME DESTINATION ${CATKIN_PACKAGE_BIN_DESTINATION}
    )
...
target_link_libraries(record_data ov_msckf_lib ${thirdparty_libraries})
